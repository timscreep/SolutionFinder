...
import styles from "./Negative.module.css";
...
const Negative = () => {
  ...
  function onSubmitHandler() {
    ...
    setNegativeSum(sum);
    navigate('/result', { state: { negativeSum: sum, positiveSum} });
  }

  return (
    <div className={styles.negative}>
      <div className={styles.negativeChild} />
      <label className={styles.solutionFinder}>Solution Finder</label>
      <Button
        className={styles.negativeButtonOK}
      ...
      <label className={styles.negative1}>Negative</label>
